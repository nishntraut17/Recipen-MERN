    ...
    <section className="box flex flex-col-reverse md:flex-row w-full gap-12 md:gap-6 justify-center items-center">
      ...
      <div className="basis-1/2 lg:basis-1/3 bg-gradient-to-t from-yellow-100 via-yellow-300 to-yellow-400 rounded-2xl px-10 py-10 h-full w-[100%] sm:w-[80%] md:w-[100%] text-center md:text-start">
        ...
        <div className="mb-5 flex flex-col gap-1">
          ...
          <a
            href="mailto:nishantraut90@gmail.com"
            className="font-semibold text-sm"
          >
            nishantraut90@gmail.com
          </a>
        </div>
        <div className="mb-5 flex flex-col gap-1">
        ...
        <div className="mb-5 flex flex-col gap-3">
          ...
          <ul className="flex justify-center md:justify-start gap-4 text-xl">
            <motion.li
              ...
              whileHover={{ y: -4 }}
            >
              <a href="https://github.com/nishntraut17">
                <AiFillGithub />
              </a>
            </motion.li>
            <motion.li
              ...
              whileHover={{ y: -4 }}
            >
              <a href="https://twitter.com/_raut_nishant">
                <AiFillTwitterCircle />
              </a>
            </motion.li>
            <motion.li
              ...
              whileHover={{ y: -4 }}
            >
              <a href="https://www.linkedin.com/in/nishntraut17">
                <AiFillLinkedin />
              </a>
            </motion.li>
          </ul>
      ...
      <div className="basis-1/2 lg:basis-1/4 m-auto flex flex-col">
        ...
        <form
          ...
          action={`https://formspree.io/f/${import.meta.env.VITE_FORMSPREE_SECRET
            }`}
          method="POST"
        >
